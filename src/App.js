...
function App() {
  const [widgets, setWidgets] = useState([
    ...
    { id: new Date().getTime() + 5, component: <StopwatchWidget />, area: 'none-widget', name: "Stopwatch" },
  ])
  ...
  return (
    <>
      ...
      <div className='none-widget' style={{marginTop:5}} >
              ...
              <Draggable>
                <div style={{ padding: 10, }} className='widget-container' >
                  <div style={{ marginBottom: 10 }}>
                    {widget.name === "Stopwatch" ? "" : <select value={widget.area}
                      onChange={(e) => {
